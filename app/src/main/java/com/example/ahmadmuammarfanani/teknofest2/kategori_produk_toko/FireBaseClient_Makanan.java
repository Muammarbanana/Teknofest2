...
public class FireBaseClient_Makanan {
    Context c;
    ...
    public FireBaseClient_Makanan(Context c, String db_url, ListView listView,String NamaToko) {
        this.c = c;
        this.db_url = db_url;
